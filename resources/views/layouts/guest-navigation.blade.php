<div class="h-full w-full">
    <div>
        ...
        <section class=" relative ">
            <div class="absolute mix-blend-multiply   top-0 right-0  bg-no-repeat bg-transparent  " >
        <img src="img/1.png" alt="" style="height:550px;width: auto;">
            </div>

            <div class=" top-0 right-0 bottom-0 left-0 w-full  h-full ">

                <nav class="  bg-transparent border-gray-200 px-2 md:px-4 py-2.5 dark:bg-gray-900">
                    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        <a href="https://flowbite.com" class="flex items-center">
                            <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo">
                            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white" style="font-family: 'Welth Catritz Free Personal Use', sans-serif;">Be our guest</span>
                        </a>
                            ...
                            <ul class="flex flex-col mt-4 font-medium md:flex-row md:space-x-8 md:mt-0">
                                ...
                                <li>
                                    <button id="mega-menu-dropdown-button" data-dropdown-toggle="mega-menu-dropdown" class="flex justify-between items-center py-2 pr-4 pl-3 w-full font-medium text-gray-700 border-b border-gray-100 md:w-auto hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-gray-400 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">
                                        Company <svg aria-hidden="true" class="ml-1 w-5 h-5 md:w-4 md:h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    </button>
                                    <div id="mega-menu-dropdown" class=" hidden absolute z-10 grid-cols-2 w-auto text-sm bg-white rounded-lg border border-gray-100 shadow-md dark:border-gray-700 md:grid-cols-3 dark:bg-gray-700" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 1110px);">
                ...
                <div class="container mx-auto  top-0 inset-x-0 text-left text-gray-800 m-8 py-24 px-6">
                    <h1 class=" text-black/50 text-3xl md:text-6xl xl:text-5xl font-bold tracking-tight mb-12">Looking and planning for your
                        dream event <br /><span class="text-white  text-3xl md:text-3xl xl:text-3xl font-bold tracking-tight ">“Dream evenets are not given but planned.<br> Start your event
                            plan by finding the right vendor and suppliers”</span></h1>
